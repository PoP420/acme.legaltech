...
namespace Acme.LegalTech.Migrations
{
    ...
    [Migration("20260810052539_20260810000000_Module03_AIOrchestration")]
    partial class _20260810000000_Module03_AIOrchestration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.LegalTech.Clauses.ClauseTaxonomy", b =>
                {
                    ...
                    b.ToTable("AppClauseTaxonomies", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Clauses.ClauseTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppClauseTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.LegalTech.Contracts.Contract", b =>
                {
                    ...
                    b.Property<string>("RiskBaseline")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Acme.LegalTech.Contracts.ContractDocumentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.LegalTech.Contracts.ContractTag", b =>
                {
                    ...
                    b.ToTable("AppContractTags", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Contracts.CounterpartyReference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCounterpartyReferences", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Contracts.DocumentExtraction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ContractDocumentVersionId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExtractedCategory")
                        .HasColumnType("text");

                    b.Property<string>("ExtractedContractStatus")
                        .HasColumnType("text");

                    b.Property<string>("ExtractedCounterparty")
                        .HasColumnType("text");

                    b.Property<DateTime?>("ExtractedEffectiveDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("ExtractedExpirationDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<string>("ExtractedRiskBaseline")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ContractDocumentVersionId");

                    b.HasIndex("ContractDocumentVersionId", "ProviderName");

                    b.ToTable("AppDocumentExtractions", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Contracts.GovernmentApprovalTier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<decimal>("AllowableVariationPercent")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Acme.LegalTech.Obligations.CompletionEvidence", b =>
                {
                    ...
                    b.ToTable("AppCompletionEvidence", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.LegalTech.Obligations.ContractObligation", b =>
                {
                    ...
                    b.Property<Guid?>("CompletionEvidenceId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SourceClauseReference")
                        .HasColumnType("text");
                    ...
                    b.ToTable("AppContractObligations", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Obligations.ObligationReminder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppObligationReminders", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Obligations.RenewalSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRenewalSchedules", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Playbooks.PlaybookProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPlaybookProfiles", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Playbooks.PlaybookRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("ClausePattern")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("AppPlaybookRules", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Processing.ExtractionSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppExtractionSuggestions", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Processing.IngestionJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppIngestionJobs", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Processing.RiskAssessmentSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRiskAssessmentSuggestions", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Processing.SuggestionDecision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSuggestionDecisions", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Reviews.ApprovalStep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppApprovalSteps", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Reviews.EscalationEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEscalationEvents", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Reviews.ReviewCase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReviewCases", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Reviews.ReviewComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReviewComments", (string)null);
                });

            modelBuilder.Entity("Acme.LegalTech.Reviews.ReviewTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReviewTasks", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.LegalTech.Clauses.ClauseTaxonomy", b =>
                {
                    b.HasOne("Acme.LegalTech.Clauses.ClauseTaxonomy", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Acme.LegalTech.Clauses.ClauseTemplate", b =>
                {
                    b.HasOne("Acme.LegalTech.Clauses.ClauseTaxonomy", "Taxonomy")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.LegalTech.Obligations.CompletionEvidence", b =>
                {
                    b.HasOne("Acme.LegalTech.Obligations.ContractObligation", "Obligation")
                        .WithMany("Evidence")
            ...
            modelBuilder.Entity("Acme.LegalTech.Playbooks.PlaybookRule", b =>
                {
                    b.HasOne("Acme.LegalTech.Playbooks.PlaybookProfile", "Playbook")
                        .WithMany("Rules")
            ...
            modelBuilder.Entity("Acme.LegalTech.Processing.ExtractionSuggestion", b =>
                {
                    b.HasOne("Acme.LegalTech.Processing.IngestionJob", "IngestionJob")
                        .WithMany("ExtractionSuggestions")
            ...
            modelBuilder.Entity("Acme.LegalTech.Processing.RiskAssessmentSuggestion", b =>
                {
                    b.HasOne("Acme.LegalTech.Processing.IngestionJob", "IngestionJob")
                        .WithMany("RiskAssessmentSuggestions")
                        .HasForeignKey("IngestionJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Acme.LegalTech.Reviews.ApprovalStep", b =>
                {
                    b.HasOne("Acme.LegalTech.Reviews.ReviewCase", "ReviewCase")
                        .WithMany()
                        .HasForeignKey("ReviewCaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReviewCase");
                });
            ...
            modelBuilder.Entity("Acme.LegalTech.Processing.IngestionJob", b =>
                {
                    b.Navigation("ExtractionSuggestions");

                    b.Navigation("RiskAssessmentSuggestions");
                });
