...
public class LegalTechDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LegalTechGlobalFeatureConfigurator.Configure();
        LegalTechModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LegalTechDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LegalTechResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/LegalTech");

            options.DefaultResourceType = typeof(LegalTechResource);
        ...
        {
            options.MapCodeNamespace("LegalTech", typeof(LegalTechResource));
        });
    }
}
